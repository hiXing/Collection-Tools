package quentindommerc.superlistview;
...
public abstract class BaseSuperAbsListview extends FrameLayout implements AbsListView.OnScrollListener {
    ...
    protected void initAttrs(AttributeSet attrs) {
        ...
        try {
            ...
            mMoreProgressId = a.getResourceId(R.styleable.superlistview_superlv__moreProgress, R.layout.super_more_progress);
            mProgressId = a.getResourceId(R.styleable.superlistview_superlv__progress, R.layout.super_progress);
