...
import com.zhx.zxing.camera.CameraManager;
import com.zhx.zxing.decoding.CaptureActivityHandler;
import com.zhx.zxing.decoding.InactivityTimer;
import com.zhx.zxing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CameraManager.init(App.getAppContext());
		initControl();
		hasSurface = false;
...
//				Utils.start_Activity(CaptureActivity.this, MainActivity.class);
				Utils.finish(CaptureActivity.this);
			}
		}
