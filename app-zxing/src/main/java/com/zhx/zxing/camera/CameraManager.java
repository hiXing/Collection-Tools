...
import com.zhx.zxing.App;
import com.zhx.zxing.Utils;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = Utils.dip2px(
			App.getAppContext(), 250);
	private static final int MIN_FRAME_HEIGHT = Utils.dip2px(
			App.getAppContext(), 250);;
	private static final int MAX_FRAME_WIDTH = Utils.dip2px(
			App.getAppContext(), 250);
	private static final int MAX_FRAME_HEIGHT = Utils.dip2px(
			App.getAppContext(), 250);
