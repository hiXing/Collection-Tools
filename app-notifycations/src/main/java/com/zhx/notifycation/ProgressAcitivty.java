...
public class ProgressAcitivty extends NotifyBaseActivity implements OnClickListener {
	...
	private void showCustomProgressNotify(String status) {
		...
		mRemoteViews.setImageViewResource(R.id.custom_progress_icon, R.mipmap.app_launcher);
