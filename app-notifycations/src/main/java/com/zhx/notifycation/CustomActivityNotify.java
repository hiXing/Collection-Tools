...
public class CustomActivityNotify extends NotifyBaseActivity implements OnClickListener{
	/** TAG */
	private final static String TAG = "CustomActivityNotify";
	/** 按钮：显示自定义通知 */
	...
	public void shwoNotify(){
		...
		view_custom.setImageViewResource(R.id.custom_icon, R.mipmap.app_launcher);
