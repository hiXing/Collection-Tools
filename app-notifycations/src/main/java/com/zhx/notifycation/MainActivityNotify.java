 ...
 * 通知栏应用
 */
public class MainActivityNotify extends NotifyBaseActivity implements OnClickListener{
...
//		notification.flags = Notification.FLAG_AUTO_CANCEL; //在通知栏上点击此通知后自动清除此通知
		...
		Intent resultIntent = new Intent(this, MainActivityNotify.class);
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.btn_show_custom:
				startActivity(new Intent(getApplicationContext(), CustomActivityNotify.class));
				break;
			default:
				break;
		}
